...
protected:
	virtual void run(void); //Ezt a metodust a származtatott osztályban felül kell írni.Ide kell beírni az utasítás szekvenciát amit a szálunk végre kell hajtson
private:
